# potentially to do for model 7: try different criterions, gradient smoothing, take log of loss or loss component, loss component balancing... play with LR scheduler
